    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mb-16">
          <div className="inline-flex rounded-2xl bg-white/80 backdrop-blur-sm p-2 shadow-xl border border-gray-200">
            <button
              className={`px-8 py-4 text-sm font-semibold rounded-xl transition-all duration-500 ${
                activeTab === "featured"
