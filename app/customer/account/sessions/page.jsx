          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 mt-1">Manage your logged-in devices and sessions</p>
              </div>
            </div>
            <button
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              {sessions.map((s) => (
                <div key={s.id} className={`border-2 rounded-xl p-6 bg-white shadow-sm hover:shadow-md transition-all duration-200 ${
                      ...
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            <span className="text-lg font-semibold text-gray-900 capitalize">{s.device_type || 'Unknown device'}</span>
                            {current?.id === s.id && (
                          ...
                          <div className="text-sm text-gray-600 mt-1">
                            <span className="mr-4">Browser: {s.browser_name || 'N/A'}</span>
                            <span className="mr-4">IP: {s.ip_address || 'N/A'}</span>
